          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <FadeIn direction="left">
              <div className="relative">
                ...
                {/* Experience badge */}
                <div className="absolute -bottom-6 -left-6 bg-gold text-primary px-6 py-4 shadow-2xl">
            ...
            <div>
              ...
              <FadeIn delay={0.1}>
                <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-salon-text mb-6 leading-tight">
                  A Journey Born from{" "}
              ...
              <FadeIn delay={0.2}>
                <p className="text-salon-muted leading-relaxed mb-5">
                  ...
                  knew from a young age that beauty was her calling.
                </p>
              </FadeIn>
              <FadeIn delay={0.3}>
                <p className="text-salon-muted leading-relaxed mb-5">
      ...
      <section className="section-padding bg-beige">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mt-4">
            {/* Mission Card */}
            <FadeIn direction="left">
              <div className="relative bg-white p-8 lg:p-12 shadow-sm group hover:shadow-xl transition-shadow duration-500 h-full">
                {/* Top gold accent */}
                ...
                <h3 className="font-heading text-2xl lg:text-3xl font-bold text-salon-text mb-4">
                  Our Mission
                </h3>
                <div className="luxury-divider-left" />
                <p className="text-salon-muted leading-relaxed text-base lg:text-lg">
            ...
            <FadeIn direction="right">
              <div className="relative bg-primary p-8 lg:p-12 shadow-sm group hover:shadow-xl transition-shadow duration-500 h-full">
                {/* Top gold accent */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-gold via-gold-light to-gold" />
                <div className="w-16 h-16 bg-gold/10 flex items-center justify-center mb-6">
              ...
              return (
                <StaggerItem key={value.title}>
                  <motion.div
                    ...
                    className="relative bg-beige-light p-8 group hover:bg-primary transition-colors duration-500 h-full"
                  >
                    {/* Number watermark */}
                    <span className="absolute top-4 right-6 text-6xl font-heading font-bold text-primary/5 group-hover:text-white/5 transition-colors duration-500 select-none">
                      {String(index + 1).padStart(2, "0")}
                    </span>

                    <div className="w-14 h-14 bg-gold/10 group-hover:bg-gold/20 flex items-center justify-center mb-5 transition-colors duration-500">
                      <Icon className="w-6 h-6 text-gold" />
                    </div>

                    <h3 className="font-heading text-xl font-bold text-salon-text group-hover:text-white mb-3 transition-colors duration-500">
                      {value.title}
                    </h3>
                    <p className="text-salon-muted group-hover:text-white/60 text-sm leading-relaxed transition-colors duration-500">
                      {value.description}
                    </p>
                  </motion.div>
                </StaggerItem>
            ...
            {teamMembers.map((member) => (
              <StaggerItem key={member.name}>
                ...
                >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                      <div className="flex flex-wrap gap-2">
                        {member.specialties.map((specialty) => (
                          <span
                            key={specialty}
                            className="text-[10px] tracking-wider uppercase px-2.5 py-1 bg-gold/20 text-gold border border-gold/30"
                          >
                            {specialty}
                          </span>
                        ))}
                  ...
                  <p className="text-gold text-sm tracking-wide uppercase mb-3">
                    {member.role}
                  </p>
      ...
      <section className="relative section-padding bg-beige overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <ScaleIn>
            ...
            <p className="max-w-2xl mx-auto text-salon-muted text-base lg:text-lg leading-relaxed mb-10">
          ...
          <FadeIn delay={0.3}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/book" className="btn-luxury inline-flex items-center gap-2">
          ...
          <FadeIn delay={0.5}>
            <p className="mt-8 text-salon-muted text-sm">
              Call us directly at{" "}
              <a
